 ...
 * @author lilia
 */
public class EditarCl extends javax.swing.JFrame {

    /**
     * Creates new form EditarCl
     */
    ...
    private void initComponents() {
        ...
        TxtAliasEd = new javax.swing.JTextField();
        ...
        CboBxEditar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nombre", "Alias", "Teléfono", "Correo", "Número de autos", " " }));
        ...
        TxtAliasEd.setBackground(new java.awt.Color(240, 240, 240));
        TxtAliasEd.setBorder(null);
        TxtAliasEd.setPreferredSize(new java.awt.Dimension(60, 20));
        TxtAliasEd.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TxtAliasEdActionPerformed(evt);
            }
        });
        ...
        TxtNum.setBackground(new java.awt.Color(240, 240, 240));
        TxtNum.setBorder(null);
        TxtNum.setPreferredSize(new java.awt.Dimension(60, 20));
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(jPanel4Layout.createSequentialGroup()
                                            ...
                                            .addGap(18, 18, 18)
                                            .addComponent(TxtAliasEd, javax.swing.GroupLayout.PREFERRED_SIZE, 217, javax.swing.GroupLayout.PREFERRED_SIZE))))))
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel4Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(TxtNum, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel4Layout.createSequentialGroup()
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(TxtAliasEd, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel13))
                .addGap(18, 18, 18)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            try {
                ...
                if(aliasdb.equals(alias)){
                    if(CboBxEditar.getSelectedItem().equals("Nombre"))
                        x = stm.executeUpdate(" update cliente set nombre='"+TxtNombre.getText()+"' where id='"+iddb+"' ");
                    else if(CboBxEditar.getSelectedItem().equals("Alias"))
                            x = stm.executeUpdate(" update cliente set alias='"+TxtAlias.getText()+"' where id='"+iddb+"' ");
                         else if(CboBxEditar.getSelectedItem().equals("Teléfono"))
                                x = stm.executeUpdate(" update cliente set telefono='"+TxtTel.getText()+"' where id='"+iddb+"' ");
                              else if(CboBxEditar.getSelectedItem().equals("Correo"))
                                        x = stm.executeUpdate(" update cliente set correo='"+TxtCorreo.getText()+"' where id='"+iddb+"' ");
                                   else
                                        x = stm.executeUpdate(" update cliente set numautos='"+Integer.parseInt(TxtNum.getText())+"' where id='"+iddb+"' ");
                }
                if(x==1){
                    x=0;
    ...
    private void TxtAliasEdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TxtAliasEdActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TxtAliasEdActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarCl.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField TxtAliasEd;
