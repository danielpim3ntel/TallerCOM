 ...
 * @author lilia
 */
public class EliminarAd extends javax.swing.JFrame {

    /** Creates new form EliminarAd */
    int x=0,idCl=0,idCa=0,idT=0;
    String alias="",aliasdb="",placas="",placasdb="",correo="",correodb="";
    boolean Tr;
    public EliminarAd() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Eliminar trabajador, cliente o carro");
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/IconoEliminar.png"))); // NOI18N
        ...
        LblQuien.setText("Correo, placas o alias:");
        ...
        CboBxSelec.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Trabajador", "Cliente", "Carro" }));
        ...
        jPanel4Layout.setHorizontalGroup(
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGap(25, 25, 25)
                                .addComponent(CboBxSelec, javax.swing.GroupLayout.PREFERRED_SIZE, 196, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(TxtQue, javax.swing.GroupLayout.PREFERRED_SIZE, 252, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanel4, javax.swing.GroupLayout.PREFERRED_SIZE, 394, Short.MAX_VALUE))
        );
    ...
    private void BtnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEliminarActionPerformed
        ...
        try {
            ...
            try {
                ...
                if(CboBxSelec.getSelectedItem().equals("Trabajador")){
                System.out.println("Entra a trabajador");    
                    ResultSet rs=stm.executeQuery("select * from trabajador");    
                    while(rs.next()){
                        correo=TxtQue.getText();
                        correodb=rs.getString("correo");
                        if(correodb.equals(correo)){
                            Tr=true;
                            idT=rs.getInt("id");
                            System.out.println("Si existe el trabajador ID="+idT);
                            break;
                        }else
                            Tr=false;
                    }
                    if(aliasdb.equals(alias) && Tr){
                        System.out.println("QUERY");
                        x = stm.executeUpdate(" update trabajador set estado='"+"Desempleado"+"' where id='"+idT+"' ");
                    }
                    if(x==1){
                        x=0;
                ...
                }else if(CboBxSelec.getSelectedItem().equals("Cliente")){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarAd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarAd().setVisible(true);
            }
        });
    }
